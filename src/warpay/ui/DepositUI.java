...
public class DepositUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fieldAmount.setPreferredSize(new java.awt.Dimension(315, 41));
                        ...
                        .addGroup(bodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(bodyLayout.createSequentialGroup()
                                .addGroup(bodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(labelAmount, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                                    .addComponent(labelPass, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE))
                                .addGap(24, 24, 24)
                                .addGroup(bodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(fieldPass, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(bodyLayout.createSequentialGroup()
                                .addGroup(bodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void buttonProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonProcessActionPerformed
        ...
        double depositAmount = Double.valueOf(fieldAmount.getText().trim());
        double newBalance = Extension.addBalance(depositAmount);

        try {

            int res = Extension.insertTransactionDetails(TYPE, depositAmount);
            if (res == 1) {
                ...
                if (res == 1) {
                    ...
                    JOptionPane.showMessageDialog(null, "Successfully deposit the requested amount to your account");
    ...
    private boolean isDepositConfirmed() {
        int opt = JOptionPane.showConfirmDialog(null, "Are you sure want to make a deposit?", TYPE, JOptionPane.YES_NO_OPTION);
